# lab2[README.md](https://github.com/user-attachments/files/25169162/README.md)
# Лабораторная работа №2: Nginx + PHP-FPM

## 👩‍💻 Автор
ФИО: Лознуха Дмитрий Олегович
Группа: ПМИ ИП3
...
✅ Результат
Сервер в Docker успешно запущен, Nginx отдаёт мою HTML-страницу с тестовой формой покупки абонемента в тренажёрный зал
